...
(function (e, t) {
    ...
    var i;
    var f;
    var a = r(t, "__defineGetter__");
    if (a) {
        o = e.bind(t.__defineGetter__);
        c = e.bind(t.__defineSetter__);
        i = e.bind(t.__lookupGetter__);
        f = e.bind(t.__lookupSetter__)
    }
    if (!Object.getPrototypeOf) {
        Object.getPrototypeOf = function z(e) {
            var r = e.__proto__;
            if (r || r === null) {
                return r
    ...
    if (Object.defineProperty) {
        var u = l({});
        var p = typeof document === "undefined" || l(document.createElement("div"));
        if (!p || !u) {
    ...
    if (!Object.getOwnPropertyDescriptor || b) {
        ...
        Object.getOwnPropertyDescriptor = function D(e, o) {
            ...
            l = {enumerable: n(e, o), configurable: true};
            if (a) {
                var u = e.__proto__;
                var p = e !== t;
                if (p) {
    ...
    if (!Object.getOwnPropertyNames) {
        Object.getOwnPropertyNames = function k(e) {
    ...
    if (Object.defineProperty) {
        var w = v({});
        var h = typeof document === "undefined" || v(document.createElement("div"));
        if (!w || !h) {
    ...
    if (!Object.defineProperty || m) {
        ...
        var g = "Object.defineProperty called on non-object: ";
        var T = "getters & setters can not be defined on this javascript engine";
        Object.defineProperty = function N(e, r, n) {
            if (typeof e !== "object" && typeof e !== "function" || e === null) {
                throw new TypeError(g + e)
            }
            if (typeof n !== "object" && typeof n !== "function" || n === null) {
                throw new TypeError(P + n)
            }
            if (m) {
                try {
                    return m.call(Object, e, r, n)
                } catch (l) {
                }
            }
            if ("value" in n) {
    ...
    if (!Object.defineProperties || E) {
        Object.defineProperties = function W(e, t) {
            if (E) {
                try {
    ...
    if (!Object.preventExtensions) {
        Object.preventExtensions = function q(e) {
            if (Object(e) !== e) {
    ...
    if (!Object.isExtensible) {
        Object.isExtensible = function J(e) {
            if (Object(e) !== e) {
